...
from wd_KdLoss_teacher_model import GrafomerModel
...
from wd_KdLoss_student_model import (TeacherWeightGroup,
                                               StudentBertModel,
                                               StudentGPT2LMHeadModel,
                                               StudentGrafomerModel
                                               )
from loss import KDLoss, WeightDistillationLoss
...
def main(cfg):
    ...
    for epoch in range(cfg.train_config.num_train_epochs):
        ...
        for batch in train_dataloader:
            ...
            att_loss, hidd_loss, pred_loss = loss_function(teacher_outputs, student_outputs, labels)
            loss = att_loss + hidd_loss + pred_loss
